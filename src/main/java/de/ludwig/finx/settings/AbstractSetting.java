...
import de.ludwig.finx.io.PropertyPreserveMode;
import de.ludwig.finx.io.PropertyPreserveModeSetting;

/**
 * A setting is the programmatic representation of a string value stored in a
 * properties file In most simple case a setting is not more than a String.
 * 
 * Implementations of this class are responsible to convert the stored string
 * value. For example convert a String that represents a Filesystem-Path to a
 * file Object.
 * 
 * @author Daniel
 * 
